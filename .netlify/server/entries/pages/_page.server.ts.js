import { c as client, u as urlFor } from "../../chunks/sanity.js";
const load = async () => {
  ...
  return {
    ...
    about: {
      ...
      tags: about?.tags?.map((tag) => tag.value).sort() ?? []
    },
    projects: projects?.map((project) => ({
      ...project,
      screenshot: project.screenshot ? {
        alt: project.screenshot.alt,
        url: project.screenshot.asset ? urlFor(project.screenshot.asset).width(1e3).format("webp").url() : null
      } : null
    })) ?? []
  };
};
